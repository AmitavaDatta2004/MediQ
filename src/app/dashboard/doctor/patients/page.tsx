...
import { ChevronRight, Bell, Users } from 'lucide-react';
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <Card className="border-none shadow-2xl shadow-slate-200/50 rounded-[2rem] overflow-hidden">
            <CardHeader className="bg-white border-b border-slate-100 px-8 py-6">
                <CardTitle className="text-2xl font-black text-slate-900 flex items-center gap-3"><Users className="w-6 h-6 text-primary" /> My Patient Roster</CardTitle>
                <CardDescription>A list of all patients who have granted you access to their medical records.</CardDescription>
            </CardHeader>
                        ...
                        consentedPatients.map((patient) => {
                            ...
                            <TableRow key={patient.id} className="hover:bg-primary/5 transition-all cursor-pointer group">
                                <TableCell className="px-8 py-7">
                                    <Link href={`/dashboard/doctor/patients/${patient.id}`} className="group/link">
                                        <div className="flex items-center gap-5">
                                            ...
                                            <div>
                                            <p className="font-black text-slate-900 group-hover/link:text-primary transition-colors text-lg tracking-tight flex items-center gap-2">
