      ...
      {hasFindings && (
        <div className="flex flex-wrap gap-2 justify-center mt-2">
          {visualFindings.map((f, i) => (
             <div key={i} className="flex items-center gap-1.5 bg-gray-100 px-2 py-1 rounded text-[10px] text-gray-600 border border-gray-200 cursor-pointer hover:bg-primary/10 hover:border-primary/20" onMouseEnter={() => setHoveredIndex(i)} onMouseLeave={() => setHoveredIndex(null)}>
