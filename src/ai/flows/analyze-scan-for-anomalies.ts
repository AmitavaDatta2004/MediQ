...
export async function analyzeScanForAnomaliesAction(
  input: TextAnalysisInput
): Promise<TextAnalysisOutput> {
  return textAnalysisFlow(input);
}

export async function generateAnalyzedImageAction(
...
5.  **Disclaimer**: Add a standard medical disclaimer.
...
**Instructions:**
1.  **Review Analysis:** Read the provided analysis to understand where the anomalies are located based on the bounding boxes.
